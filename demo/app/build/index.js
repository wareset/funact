...
function Description() {
  return (
    xe('div', null
      ...
      , xe('p', null, "В данный момент демо, как и сама библиотека, еще не готовы. Но ниже есть примеры работы хуков для демонстрации того, что библиотека действительно работает. Абсолютно все компоненты которые здесь есть (Header, Accordion, Buttons, etc.) так же написаны на этой библиотеке."
